...
//
// On Wed Oct  8 17:02:02 BST 2014
//
...
// Conflict-free: client_request_get, server0_request_put, server1_request_put
// Sequenced before (restricted): client_response_put
// Sequenced after: server0_response_get, server1_response_get
//
...
// RDY_client_response_put        O     1 const
...
// EN_server0_response_get        I     1 unused
// EN_server1_response_get        I     1 unused
//
...
module mkBluetreeMux2(CLK,
  ...
  // inlined wires
  wire down_valid_0_1$whas, down_valid_1_1$whas;
  ...
  wire [7 : 0] x__h1007, x__h1149, x__h1627, y_avValue_cpu_id__h1526;
  ...
  // action method client_response_put
  assign RDY_client_response_put = 1'd1 ;
  ...
  assign MUX_up$enq_1__VAL_1 =
	     { in0$D_OUT[197:16], x__h1007, in0$D_OUT[7:0] } ;
  assign MUX_up$enq_1__VAL_2 =
	     { in1$D_OUT[197:16], x__h1149, in1$D_OUT[7:0] } ;

  // inlined wires
  assign down_valid_0_1$whas =
	     EN_client_response_put &&
	     (client_response_put[7:0] == 8'd255 || !client_response_put[0]) ;
  assign down_valid_1_1$whas =
	     EN_client_response_put && client_response_put[0] ;

  // register down
  assign down$D_IN = { client_response_put[174:8], x__h1627 } ;
  assign down$EN = EN_client_response_put ;

  // register down_valid_0
  assign down_valid_0$D_IN = down_valid_0_1$whas ;
  assign down_valid_0$EN = 1'd1 ;

  // register down_valid_1
  assign down_valid_1$D_IN = down_valid_1_1$whas ;
  assign down_valid_1$EN = 1'd1 ;
  ...
  assign x__h1627 =
	     (client_response_put[7:0] == 8'd255) ?
	       ...
	       y_avValue_cpu_id__h1526 ;
  assign y_avValue_cpu_id__h1526 = { 1'd0, client_response_put[7:1] } ;
