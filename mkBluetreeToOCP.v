...
//
// On Wed Oct  8 17:07:35 BST 2014
//
...
module mkBluetreeToOCP(CLK,
  ...
  wire WILL_FIRE_RL_client_continue_write,
       ...
       WILL_FIRE_RL_client_tie_off_resp,
       WILL_FIRE_RL_client_write_reply_F_F,
       WILL_FIRE_RL_client_write_reply_F_T,
       WILL_FIRE_RL_client_write_reply_T;

  // inputs to muxes for submodule ports
  wire [197 : 0] MUX_client_tmp_pkt$write_1__VAL_1,
		 MUX_client_tmp_pkt$write_1__VAL_2,
		 MUX_client_tmp_pkt$write_1__VAL_3;
  wire [174 : 0] MUX_client_data_resp$write_1__VAL_2;
  wire [1 : 0] MUX_client_pkt_rd_ptr$write_1__VAL_1,
	       MUX_client_resp_rd_ptr$write_1__VAL_1;
  wire MUX_bridge_s_data$wset_1__SEL_1,
       MUX_client_pkt_ok$write_1__SEL_1,
       MUX_client_sm_state$write_1__SEL_2;

  // remaining internal signals
  wire [127 : 0] pkt_data__h1153, pkt_data__h1474, x_data__h2112;
  wire [15 : 0] pkt_ben__h1154, pkt_ben__h1475;
  ...
  // value method slave_get_SResp
  assign slave_get_SResp = WILL_FIRE_RL_client_tie_off_resp ? 2'd0 : 2'd1 ;

  // value method slave_get_SData
  assign slave_get_SData =
	     MUX_bridge_s_data$wset_1__SEL_1 ?
  ...
  // rule RL_client_write_reply_T
  assign WILL_FIRE_RL_client_write_reply_T =
	     client_data_resp[174:172] == 3'd3 && client_sm_state == 3'd4 ;

  // rule RL_client_write_reply_F_T
  assign WILL_FIRE_RL_client_write_reply_F_T =
	     client_data_resp[174:172] != 3'd3 &&
	     client_resp_rd_ptr == 2'd3 &&
	     client_sm_state == 3'd4 ;

  // rule RL_client_write_reply_F_F
  assign WILL_FIRE_RL_client_write_reply_F_F =
	     client_data_resp[174:172] != 3'd3 &&
	     client_resp_rd_ptr != 2'd3 &&
	     client_sm_state == 3'd4 ;

  // rule RL_client_tie_off_resp
  assign WILL_FIRE_RL_client_tie_off_resp =
	     !WILL_FIRE_RL_client_write_reply_F_F &&
	     !WILL_FIRE_RL_client_write_reply_F_T &&
	     !WILL_FIRE_RL_client_write_reply_T ;

  // inputs to muxes for submodule ports
  assign MUX_bridge_s_data$wset_1__SEL_1 =
	     WILL_FIRE_RL_client_write_reply_F_F ||
	     WILL_FIRE_RL_client_write_reply_F_T ;
  assign MUX_client_pkt_ok$write_1__SEL_1 =
	     WILL_FIRE_RL_client_continue_write && client_pkt_rd_ptr == 2'd3 ;
  assign MUX_client_sm_state$write_1__SEL_2 =
	     WILL_FIRE_RL_client_write_reply_F_T ||
	     WILL_FIRE_RL_client_write_reply_T ;
  assign MUX_client_data_resp$write_1__VAL_2 =
  ...
  assign MUX_client_resp_rd_ptr$write_1__VAL_1 = client_resp_rd_ptr + 2'd1 ;
  ...
  assign client_data_resp$D_IN =
	     EN_bluetree_response_put ?
	       bluetree_response_put :
	       MUX_client_data_resp$write_1__VAL_2 ;
  ...
  assign client_resp_rd_ptr$D_IN =
	     WILL_FIRE_RL_client_write_reply_F_F ?
	       MUX_client_resp_rd_ptr$write_1__VAL_1 :
	       2'd0 ;
  assign client_resp_rd_ptr$EN = MUX_bridge_s_data$wset_1__SEL_1 ;

  // register client_sm_state
  always@(MUX_client_sm_state$write_1__SEL_2 or
  ...
  begin
    case (1'b1) // synopsys parallel_case
      MUX_client_sm_state$write_1__SEL_2: client_sm_state$D_IN = 3'd0;
      ...
      default: client_sm_state$D_IN = 3'b010 /* unspecified value */ ;
    endcase
  end
  ...
  // remaining internal signals
  assign pkt_ben__h1154 = { slave_put_MBE_x, 12'd0 } ;
  assign pkt_ben__h1475 = { slave_put_MBE_x, client_tmp_pkt[67:56] } ;
  assign pkt_data__h1153 = { slave_put_MData_x, 96'd0 } ;
  assign pkt_data__h1474 = { slave_put_MData_x, client_tmp_pkt[195:100] } ;
  assign x_data__h2112 = { 32'd0, client_data_resp[171:76] } ;
